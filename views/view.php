<?php
	...
	class View{
		...
		public function render($filename,$parameters=array(),$template=false){//$parameters:모델의 결과값
			...
			$content = ob_get_clean();//현재 버퍼내용을 반환해서 출력버퍼를 삭제
                                //즉, view의 결과값들이 contents에 담김
