...
class Response {
	...
	protected 	$_statusCode 	= 200;		//상태코드 저장 200번대: 정상코드
	protected 	$_statusMsg		= 'OK';		//상태메시지 저장
	protected 	$_headers 		= array();	//응답헤더의 필드를 저장
	const 		HTTP 			= 'HTTP/1.1';//stateLine을 구성

	// status code, status message를 지정
	public function setStatusCode($code, $msg = '') {//200번이 아닐경우 상태코드를 정할 수 있음
	...
	// 컨텐츠의 설정
	public function setContent($content) {//view 클래스에서 사용
